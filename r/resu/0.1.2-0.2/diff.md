# Comparing `tmp/resu-0.1.2.tar.gz` & `tmp/resu-0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "resu-0.1.2.tar", last modified: Fri Jan  1 00:00:00 2016, max compression
+gzip compressed data, was "resu-0.2.tar", last modified: Sun May 15 13:29:45 2022, max compression
```

## Comparing `resu-0.1.2.tar` & `resu-0.2.tar`

### file list

```diff
@@ -1,9 +1,9 @@
--rw-r--r--   0        0        0     1101 2022-05-15 08:09:23.573397 resu-0.1.2/.github/workflows/build-checks.yml
--rw-r--r--   0        0        0     3105 2022-05-15 13:42:53.360968 resu-0.1.2/.gitignore
--rw-r--r--   0        0        0     1072 2022-05-15 07:12:25.704570 resu-0.1.2/LICENSE
--rw-r--r--   0        0        0     2559 2022-05-15 09:23:07.867270 resu-0.1.2/README.md
--rw-r--r--   0        0        0      437 2023-08-02 19:14:24.664111 resu-0.1.2/pyproject.toml
--rw-r--r--   0        0        0       27 2022-05-15 05:39:21.980043 resu-0.1.2/requirements.txt
--rw-r--r--   0        0        0      107 2023-08-02 19:11:46.502539 resu-0.1.2/resu/__init__.py
--rw-r--r--   0        0        0     6074 2022-10-24 16:52:06.880052 resu-0.1.2/resu/resu.py
--rw-r--r--   0        0        0     2862 1970-01-01 00:00:00.000000 resu-0.1.2/PKG-INFO
...
### Comparing `resu-0.1.2/.github/workflows/build-checks.yml` & `resu-0.2/.github/workflows/build-checks.yml`

 * *Files identical despite different names*

### Comparing `resu-0.1.2/.gitignore` & `resu-0.2/.gitignore`
...
### Comparing `resu-0.1.2/LICENSE` & `resu-0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `resu-0.1.2/README.md` & `resu-0.2/README.md`

 * *Files identical despite different names*

### Comparing `resu-0.1.2/resu/resu.py` & `resu-0.2/resu/resu.py`
