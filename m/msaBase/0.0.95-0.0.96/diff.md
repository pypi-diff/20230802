# Comparing `tmp/msaBase-0.0.95.tar.gz` & `tmp/msaBase-0.0.96.tar.gz`
...
### Comparing `msaBase-0.0.95/msaBase.egg-info/SOURCES.txt` & `msaBase-0.0.96/msaBase.egg-info/SOURCES.txt`
