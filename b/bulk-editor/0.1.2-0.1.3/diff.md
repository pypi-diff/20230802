# Comparing `tmp/bulk_editor-0.1.2.tar.gz` & `tmp/bulk_editor-0.1.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/bulk_editor-0.1.2.tar", last modified: Fri Jul 14 18:49:27 2023, max compression
+gzip compressed data, was "dist/bulk_editor-0.1.3.tar", last modified: Wed Aug  2 09:00:04 2023, max compression
```

## Comparing `bulk_editor-0.1.2.tar` & `bulk_editor-0.1.3.tar`

### file list

```diff
@@ -1,17 +1,18 @@
-drwxr-xr-x   0 harinikeshr   (501) admin       (80)        0 2023-07-14 18:49:27.000000 bulk_editor-0.1.2/
--rw-r--r--   0 harinikeshr   (501) admin       (80)     2157 2023-07-14 18:49:27.000000 bulk_editor-0.1.2/PKG-INFO
-drwxr-xr-x   0 harinikeshr   (501) admin       (80)        0 2023-07-14 18:49:27.000000 bulk_editor-0.1.2/bulkeditor/
--rw-r--r--   0 harinikeshr   (501) admin       (80)     3658 2023-07-14 18:48:45.000000 bulk_editor-0.1.2/bulkeditor/__init__.py
--rw-r--r--   0 harinikeshr   (501) admin       (80)       10 2023-07-14 17:16:25.000000 bulk_editor-0.1.2/bulkeditor/Certificate.txt
--rw-r--r--   0 harinikeshr   (501) admin       (80)    20953 2023-07-14 08:02:23.000000 bulk_editor-0.1.2/bulkeditor/logo.png
--rw-r--r--   0 harinikeshr   (501) admin       (80)   167336 2023-07-14 08:02:23.000000 bulk_editor-0.1.2/bulkeditor/Roboto-Bold.ttf
--rw-r--r--   0 harinikeshr   (501) admin       (80)     1070 2023-07-11 07:16:48.000000 bulk_editor-0.1.2/LICENSE
-drwxr-xr-x   0 harinikeshr   (501) admin       (80)        0 2023-07-14 18:49:27.000000 bulk_editor-0.1.2/bulk_editor.egg-info/
--rw-r--r--   0 harinikeshr   (501) admin       (80)     2157 2023-07-14 18:49:27.000000 bulk_editor-0.1.2/bulk_editor.egg-info/PKG-INFO
--rw-r--r--   0 harinikeshr   (501) admin       (80)      297 2023-07-14 18:49:27.000000 bulk_editor-0.1.2/bulk_editor.egg-info/SOURCES.txt
--rw-r--r--   0 harinikeshr   (501) admin       (80)       21 2023-07-14 18:49:27.000000 bulk_editor-0.1.2/bulk_editor.egg-info/requires.txt
--rw-r--r--   0 harinikeshr   (501) admin       (80)       11 2023-07-14 18:49:27.000000 bulk_editor-0.1.2/bulk_editor.egg-info/top_level.txt
--rw-r--r--   0 harinikeshr   (501) admin       (80)        1 2023-07-14 18:49:27.000000 bulk_editor-0.1.2/bulk_editor.egg-info/dependency_links.txt
--rw-r--r--   0 harinikeshr   (501) admin       (80)     2336 2023-07-14 18:41:57.000000 bulk_editor-0.1.2/README.md
--rw-r--r--   0 harinikeshr   (501) admin       (80)     4810 2023-07-14 18:49:16.000000 bulk_editor-0.1.2/setup.py
--rw-r--r--   0 harinikeshr   (501) admin       (80)       38 2023-07-14 18:49:27.000000 bulk_editor-0.1.2/setup.cfg
...
### Comparing `bulk_editor-0.1.2/PKG-INFO` & `bulk_editor-0.1.3/PKG-INFO`
...
### Comparing `bulk_editor-0.1.2/bulkeditor/__init__.py` & `bulk_editor-0.1.3/bulkeditor/__init__.py`
...
+from img_to_pdf import ImageToPdf
...
### Comparing `bulk_editor-0.1.2/bulkeditor/logo.png` & `bulk_editor-0.1.3/bulkeditor/logo.png`

 * *Files identical despite different names*

### Comparing `bulk_editor-0.1.2/bulkeditor/Roboto-Bold.ttf` & `bulk_editor-0.1.3/bulkeditor/Roboto-Bold.ttf`

 * *Files identical despite different names*

### Comparing `bulk_editor-0.1.2/LICENSE` & `bulk_editor-0.1.3/LICENSE`

 * *Files identical despite different names*

### Comparing `bulk_editor-0.1.2/bulk_editor.egg-info/PKG-INFO` & `bulk_editor-0.1.3/bulk_editor.egg-info/PKG-INFO`
...
### Comparing `bulk_editor-0.1.2/README.md` & `bulk_editor-0.1.3/README.md`

 * *Files identical despite different names*

### Comparing `bulk_editor-0.1.2/setup.py` & `bulk_editor-0.1.3/setup.py`
