# Comparing `tmp/hecdbetz-2.0.tar.gz` & `tmp/hecdbetz-3.0.tar.gz`
...
## Comparing `hecdbetz-2.0.tar` & `hecdbetz-3.0.tar`
...
### Comparing `hecdbetz-2.0/LICENSE` & `hecdbetz-3.0/LICENSE`

 * *Files identical despite different names*

### Comparing `hecdbetz-2.0/hecdbetz/calculate.py` & `hecdbetz-3.0/hecdbetz/calculate.py`
