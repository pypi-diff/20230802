# Comparing `tmp/zmq_ai_client_python-0.5.tar.gz` & `tmp/zmq_ai_client_python-0.6.tar.gz`
...
## Comparing `zmq_ai_client_python-0.5.tar` & `zmq_ai_client_python-0.6.tar`
...
### Comparing `zmq_ai_client_python-0.5/zmq_ai_client_python/client.py` & `zmq_ai_client_python-0.6/zmq_ai_client_python/client.py`

 * *Files identical despite different names*

### Comparing `zmq_ai_client_python-0.5/zmq_ai_client_python/client_test.py` & `zmq_ai_client_python-0.6/zmq_ai_client_python/client_test.py`
