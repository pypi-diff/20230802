# Comparing `tmp/kubric-nightly-2023.8.1.tar.gz` & `tmp/kubric-nightly-2023.8.2.tar.gz`
...
### Comparing `kubric-nightly-2023.8.1/kubric/renderer/blender.py` & `kubric-nightly-2023.8.2/kubric/renderer/blender.py`
