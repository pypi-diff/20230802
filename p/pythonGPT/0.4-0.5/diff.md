# Comparing `tmp/pythonGPT-0.4.tar.gz` & `tmp/pythonGPT-0.5.tar.gz`
...
## Comparing `pythonGPT-0.4.tar` & `pythonGPT-0.5.tar`
...
### Comparing `pythonGPT-0.4/pythonGPT/__init__.py` & `pythonGPT-0.5/pythonGPT/__init__.py`
