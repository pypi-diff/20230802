# Comparing `tmp/PythonMetaTrader5-1.0.2.tar.gz` & `tmp/PythonMetaTrader5-1.0.3.tar.gz`
...
## Comparing `PythonMetaTrader5-1.0.2.tar` & `PythonMetaTrader5-1.0.3.tar`
...
### Comparing `PythonMetaTrader5-1.0.2/setup.cfg` & `PythonMetaTrader5-1.0.3/setup.cfg`
