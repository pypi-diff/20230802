# Comparing `tmp/fwdviewpy-0.2.2.tar.gz` & `tmp/fwdviewpy-0.2.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "fwdviewpy-0.2.2.tar", last modified: Wed Aug  2 14:32:15 2023, max compression
+gzip compressed data, was "fwdviewpy-0.2.3.tar", last modified: Wed Aug  2 14:56:09 2023, max compression
```

## Comparing `fwdviewpy-0.2.2.tar` & `fwdviewpy-0.2.3.tar`

### file list

```diff
@@ -1,13 +1,13 @@
-drwxrwxrwx   0        0        0        0 2023-08-02 14:32:15.567266 fwdviewpy-0.2.2/
--rw-rw-rw-   0        0        0      620 2023-08-02 14:32:15.565297 fwdviewpy-0.2.2/PKG-INFO
-drwxrwxrwx   0        0        0        0 2023-08-02 14:32:15.525889 fwdviewpy-0.2.2/fwdviewpy/
--rw-rw-rw-   0        0        0      135 2023-07-05 15:13:34.000000 fwdviewpy-0.2.2/fwdviewpy/__init__.py
--rw-rw-rw-   0        0        0    34209 2023-08-02 14:28:04.000000 fwdviewpy-0.2.2/fwdviewpy/main.py
-drwxrwxrwx   0        0        0        0 2023-08-02 14:32:15.559440 fwdviewpy-0.2.2/fwdviewpy.egg-info/
--rw-rw-rw-   0        0        0      620 2023-08-02 14:32:15.000000 fwdviewpy-0.2.2/fwdviewpy.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      212 2023-08-02 14:32:15.000000 fwdviewpy-0.2.2/fwdviewpy.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-08-02 14:32:15.000000 fwdviewpy-0.2.2/fwdviewpy.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        9 2023-08-02 14:32:15.000000 fwdviewpy-0.2.2/fwdviewpy.egg-info/requires.txt
--rw-rw-rw-   0        0        0       10 2023-08-02 14:32:15.000000 fwdviewpy-0.2.2/fwdviewpy.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2023-08-02 14:32:15.567266 fwdviewpy-0.2.2/setup.cfg
--rw-rw-rw-   0        0        0      818 2023-08-02 14:19:06.000000 fwdviewpy-0.2.2/setup.py
...
### Comparing `fwdviewpy-0.2.2/PKG-INFO` & `fwdviewpy-0.2.3/PKG-INFO`
...
### Comparing `fwdviewpy-0.2.2/fwdviewpy/main.py` & `fwdviewpy-0.2.3/fwdviewpy/main.py`
...
-        logging.basicConfig(filename=f'{PROJECT_NAME}/Log_Archive/DelphixEngineSessionManager_{formatted_date_time}.log',
...
### Comparing `fwdviewpy-0.2.2/fwdviewpy.egg-info/PKG-INFO` & `fwdviewpy-0.2.3/fwdviewpy.egg-info/PKG-INFO`
...
### Comparing `fwdviewpy-0.2.2/setup.py` & `fwdviewpy-0.2.3/setup.py`
