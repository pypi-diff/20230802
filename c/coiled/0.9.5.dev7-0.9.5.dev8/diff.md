# Comparing `tmp/coiled-0.9.5.dev7.tar.gz` & `tmp/coiled-0.9.5.dev8.tar.gz`
...
### Comparing `coiled-0.9.5.dev7/coiled/v2/cluster.py` & `coiled-0.9.5.dev8/coiled/v2/cluster.py`
