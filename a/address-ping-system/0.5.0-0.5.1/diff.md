# Comparing `tmp/address_ping_system-0.5.0.tar.gz` & `tmp/address_ping_system-0.5.1.tar.gz`
...
+gzip compressed data, was "address_ping_system-0.5.1.tar", last modified: Wed Aug  2 12:18:04 2023, max compression
```

## Comparing `address_ping_system-0.5.0.tar` & `address_ping_system-0.5.1.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-08-02 12:18:04.973752 address_ping_system-0.5.1/
+-rw-r--r--   0 runner    (1001) docker     (123)    16725 2023-08-02 12:17:51.000000 address_ping_system-0.5.1/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)     2957 2023-08-02 12:18:04.973752 address_ping_system-0.5.1/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     2038 2023-08-02 12:17:51.000000 address_ping_system-0.5.1/README.md
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-08-02 12:18:04.973752 address_ping_system-0.5.1/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)      710 2023-08-02 12:17:51.000000 address_ping_system-0.5.1/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-08-02 12:18:04.969751 address_ping_system-0.5.1/src/
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-08-02 12:18:04.969751 address_ping_system-0.5.1/src/address_ping_system/
+-rw-r--r--   0 runner    (1001) docker     (123)       36 2023-08-02 12:17:51.000000 address_ping_system-0.5.1/src/address_ping_system/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     2659 2023-08-02 12:17:51.000000 address_ping_system-0.5.1/src/address_ping_system/address_ping_system.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-08-02 12:18:04.973752 address_ping_system-0.5.1/src/address_ping_system.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     2957 2023-08-02 12:18:04.000000 address_ping_system-0.5.1/src/address_ping_system.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      439 2023-08-02 12:18:04.000000 address_ping_system-0.5.1/src/address_ping_system.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-08-02 12:18:04.000000 address_ping_system-0.5.1/src/address_ping_system.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       70 2023-08-02 12:18:04.000000 address_ping_system-0.5.1/src/address_ping_system.egg-info/entry_points.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-08-02 12:18:04.000000 address_ping_system-0.5.1/src/address_ping_system.egg-info/not-zip-safe
+-rw-r--r--   0 runner    (1001) docker     (123)       37 2023-08-02 12:18:04.000000 address_ping_system-0.5.1/src/address_ping_system.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       20 2023-08-02 12:18:04.000000 address_ping_system-0.5.1/src/address_ping_system.egg-info/top_level.txt
```

### Comparing `address_ping_system-0.5.0/LICENSE` & `address_ping_system-0.5.1/LICENSE`

 * *Files identical despite different names*

### Comparing `address_ping_system-0.5.0/PKG-INFO` & `address_ping_system-0.5.1/PKG-INFO`
...
### Comparing `address_ping_system-0.5.0/README.md` & `address_ping_system-0.5.1/README.md`

 * *Files identical despite different names*

### Comparing `address_ping_system-0.5.0/setup.py` & `address_ping_system-0.5.1/setup.py`
...
### Comparing `address_ping_system-0.5.0/src/address_ping_system/address_ping_system.py` & `address_ping_system-0.5.1/src/address_ping_system/address_ping_system.py`
...
### Comparing `address_ping_system-0.5.0/src/address_ping_system.egg-info/PKG-INFO` & `address_ping_system-0.5.1/src/address_ping_system.egg-info/PKG-INFO`
